                                ...
                                <div class="card-body p-5">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            <label class="text-gray-600 small">Full Name</label>
                                            <input class="form-control form-control-solid py-4" type="text" placeholder
                                                aria-label="text" name="name" value="{{ old('name') }}" required/>
                                                @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-solid py-4" name="email" value="{{ old('email') }}" type="email" placeholder
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-solid py-4" name="password" type="password"
                                                placeholder aria-label="Password" aria-describedby="passwordExample" required/>
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group">
                                            <label class="text-gray-600 small" for="passwordExample">Konfirmasi Password</label>
                                            <input id="password-confirm" type="password" class="form-control form-control-solid py-4" name="password_confirmation"
                                                placeholder aria-label="Password" aria-describedby="passwordExample" required/>
                                        </div>
